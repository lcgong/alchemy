...
import {printBlockTokenState} from '../debug';
...
export function parseQuestion(state: any, startLine: any, endLine: any, silent: any) {
  ...
  var level: any = levelMarker.length;
...
function pushQuestionNoTokens(state: any, questionNo: any, startLine: any, endLine: any) {
  var token;
  var oldParentType = state.parentType;
...
function pushQuestionStemTokens(state: any, startLine: any, endLine: any) {
...
function parseSettings(token: any, settings: any) {
